...
void RenderFrame(GLFWwindow* window, Scene* scene);
...
int main(int argc, char **argv)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		DrawImguiMenus(io,&scene);
       	...
       	RenderFrame(window, &scene);// --> go to line 137
...
void RenderFrame(GLFWwindow* window, Scene* scene)
{
	...
	// #######################################
	scene->Viewport(displayW, displayH);
	scene->ClearColorBuffer(GetClearColor());
